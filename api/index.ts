...
Return this exact JSON:
{
  "nodes": [
    {
      "node_id": "root_01",
      "avatar_script": "opening story text here",
      "teacher_prompt": "teacher guidance here",
      "is_branching": true,
      "choices": [
        {"button_text": "Choice A", "next_node_id": "branch_a"},
        {"button_text": "Choice B", "next_node_id": "branch_b"}
      ],
      "image_prompt": "English scene description, ${STYLE_PROMPTS[visualStyle]}, under 60 words"
    },
    {
      "node_id": "branch_a",
      "avatar_script": "result of choice A",
      "teacher_prompt": "teacher tip",
      "is_branching": false,
      "choices": [],
    ...
    {
      "node_id": "branch_b",
      "avatar_script": "result of choice B",
      "teacher_prompt": "teacher tip",
      "is_branching": false,
      "choices": [],
      "image_prompt": "English scene, ${STYLE_PROMPTS[visualStyle]}"
    ...
    {
      "node_id": "ending",
      "avatar_script": "story ending",
      "teacher_prompt": "teacher summary",
      "is_branching": false,
      "choices": [],
...
app.post("/api/generate", async (req: Request, res: Response) => {
  const {
    ...
    image_count = 3,
    voice_lang = "zh-TW",
    avatar_style = "bear", // passed through to client; not used server-side
  } = req.body;
  ...
  try {
    ...
    // Generate images — cap prompts to clampedCount.
    // If clampedCount < number of nodes, remaining nodes get a placeholder.
    // If clampedCount > number of nodes, extra images are unused.
